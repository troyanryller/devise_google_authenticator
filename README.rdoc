...
== Changes
* Version 0.3.18 - A few more bug-fixes. Test-cases are now passing in Ruby 2.3.0. No longer reliant on external Google APIs for generating QR code. Support for devise authentication usernames other than email address. Bugfix, making migration to set gauth_secret field optional. This provides better support for our friends using Mongoid
